...
import { space, radius, fontSize, fontWeight, type Palette } from "../lib/theme";
...
function makeStyles(c: Palette) {
  return StyleSheet.create({
    ...
    signInText: { color: c.primaryDark, fontWeight: fontWeight.semibold, fontSize: fontSize.base },
    ...
    avatar: { width: 28, height: 28, borderRadius: 14, backgroundColor: c.evidenceBg },
    avatarFallback: { alignItems: "center", justifyContent: "center" },
    avatarText: { color: c.primary, fontWeight: fontWeight.bold, fontSize: fontSize.base },
    signOut: { color: c.primary, fontWeight: fontWeight.semibold, fontSize: fontSize.base },
  });
}
